...
We will be analyzing annual European Stock Data from 1990-1198. Particularly, we are interested in charting the prices for the DAX index and decomposing the data as a multiplicative time series.

```{r 1}
# Plot data for DAX in blue and draw a red to indicate 1997
plot(EuStockMarkets[, 'DAX'],
     main='Daily Closing Stock Prices for Major EU Indices 1991-1998',
     xlab='Year',
...
### **2:** Temperature Data
We are interested in predicting a future trend for the maximum annual temperature of Moorabbin Airport in Melbourne based on historical data spanning 1971-2016. Multiple prediction models will be compared to find the ideal model suited for this problem.
```{r 2}
...
We would like to interpret wand sales data for two wand salesmen from 1970-2017. To do this, we will import, clean, and merge the two sales datasets in R and create an interactive DyGraph of the combined data.
